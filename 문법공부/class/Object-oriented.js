...
class User4 {
    constructor(a) {
        this.familyName = 'kim'; //class 내에서만 변경 가능! 불러오기 가능!
...
class User6 {
    constructor() {
        this.x = 10; //protected 는 extends 된 class안에서 사용가능, 자식들은 여전히 사용불가!
    }
}
...
class User7 {
    constructor() {
        ...
        this.y = 20; // 자식만 사용가능! constructor도 마찬가지
    }
}
User7.x = 10; //부모 class에 직접 부여됨 (자식에게 안물려줌, extends하면 잘 따라옴)
let 자식2 = new User7();
